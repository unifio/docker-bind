...
USER="named"
GROUP="named"
## Run in foreground and log to logging directories mounted
COMMAND_OPTIONS_DEFAULT="-f"
NAMED_UID_DEFAULT="1000"
NAMED_GID_DEFAULT="1000"
...
chown -R ${USER}:${GROUP} /var/named /etc/bind /var/run/named /var/log/named
chmod -R o-rwx /var/named /etc/bind /var/run/named /var/log/named
echo "[DONE]"
